    ...
    <div className="bg-slate-950 border-r border-slate-800 flex flex-col h-full shrink-0 w-full">
      <div className="h-16 flex items-center justify-between px-6 border-b border-slate-800 shrink-0">
        <div className={`flex items-center gap-2 ${isCollapsed ? 'hidden' : 'block'}`}>
          <img src="/logo.jpg" alt="AquaSync" className="w-8 h-8 rounded-full object-cover shadow border border-slate-700" />
          <span className="text-xl font-bold text-white tracking-wide">AquaSync</span>
        </div>
