    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-slate-300 mb-1">Select Equipment/Tool *</label>
          <select
            required
        ...
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-1">Maintenance Type *</label>
          <input
            type="text"
            required
