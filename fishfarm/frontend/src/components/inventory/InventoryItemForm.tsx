  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-shadow bg-slate-800 text-white placeholder-slate-500 ${errors.itemName ? 'border-red-500' : 'border-slate-200'}`}
        ...
        <div>
          ...
          <div className="flex space-x-2">
            <input
              ...
              className="flex-1 px-4 py-2 border border-slate-700 bg-slate-800 text-white placeholder-slate-500 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-shadow"
            />
            <input
              type="text"
              required
              ...
              className="w-24 px-4 py-2 border border-slate-700 bg-slate-800 text-white placeholder-slate-500 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-shadow"
            />
          </div>
          {(errors.currentQuantity || errors.unit) && (
            <p className="text-red-400 text-xs mt-1">Both quantity and unit are required</p>
          )}
        </div>

        <div>
          <label className="block text-sm font-medium text-slate-300 mb-1">Low Stock Alert Threshold *</label>
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-2 border rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-shadow bg-slate-800 text-white placeholder-slate-500 ${errors.reorderThreshold ? 'border-red-500' : 'border-slate-200'}`}
            />
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            className="w-full px-4 py-2 border border-slate-700 bg-slate-800 text-white placeholder-slate-500 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-shadow resize-none"
      ...
      <div className="flex justify-between items-center pt-6 border-t border-slate-800">
        <div>
          {initialData?.itemName && onDelete && (
            <button
              type="button"
              onClick={onDelete}
              disabled={isLoading}
              className="px-4 py-2 text-red-400 hover:text-red-300 hover:bg-red-400/10 rounded-xl transition-colors font-medium"
            >
              Delete Item
            </button>
          )}
