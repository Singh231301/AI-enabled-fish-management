    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="font-medium text-slate-600">Total Expenses</h3>
        </div>
        <p className="text-2xl font-bold text-slate-800">₹{stats.totalExpenses.toLocaleString()}</p>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="font-medium text-slate-600">Total Revenue</h3>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
        <div className="flex items-center gap-3 mb-2">
          <div className={`p-2 rounded-lg ${stats.isProfitable ? 'bg-sky-50 text-sky-600' : 'bg-orange-50 text-orange-600'}`}>
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
          </div>
          <h3 className="font-medium text-slate-600">Net {stats.isProfitable ? 'Profit' : 'Loss'}</h3>
        </div>
        <p className={`text-2xl font-bold ${stats.isProfitable ? 'text-green-600' : 'text-red-600'}`}>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="font-medium text-slate-600">Pending Payments</h3>
        </div>
        <p className="text-2xl font-bold text-slate-800">₹{stats.totalPendingAmount.toLocaleString()}</p>
