  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-1">Price Type *</label>
          <select 
            {...register('priceType')}
            className="w-full rounded-lg bg-slate-800 border-slate-700 text-white shadow-sm focus:border-sky-500 focus:ring-sky-500"
          >
        ...
        <div className="md:col-span-2">
          <label className="block text-sm font-medium text-slate-300 mb-1">Market Location (Optional)</label>
          <input 
            type="text" 
