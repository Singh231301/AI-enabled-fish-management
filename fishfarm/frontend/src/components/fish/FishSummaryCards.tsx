    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      <div className="bg-slate-800 rounded-lg  border border-slate-700 p-5">
        <div className="flex items-center text-slate-400 mb-2">
          <Fish className="w-5 h-5 mr-2 text-sky-400" />
          <h3 className="text-sm font-medium">Total Stocked</h3>
        </div>
        <p className="text-2xl font-bold text-white">{mortalitySummary.totalStocked.toLocaleString()}</p>
        <p className="text-xs text-slate-400 mt-1">Est. Alive: {mortalitySummary.estimatedAlive.toLocaleString()}</p>
      </div>
      ...
      <div className="bg-slate-800 rounded-lg  border border-slate-700 p-5">
        ...
        <div className="flex items-end">
          <p className="text-2xl font-bold text-white">{mortalitySummary.survivalRate.toFixed(1)}%</p>
        </div>
      ...
      <div className="bg-slate-800 rounded-lg  border border-slate-700 p-5">
        ...
        <p className="text-2xl font-bold text-white">{mortalitySummary.totalMortality.toLocaleString()}</p>
        <p className="text-xs text-slate-400 mt-1">Today: <span className="text-red-600 font-medium">{mortalitySummary.todayMortality}</span></p>
      </div>
